            ...
            <td class="container"
                ...
                <div class="content"
                    ...
                    <span class="preheader"
                        ...
                        Hi there, {{SenderName}}({{EmailFrom}}) shared a file with you</span>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
                        ...
                        <tr>
                            <td><img src="./img/dropbox.png" alt="logo"
                        ...
                        <tr>
                            <td class="wrapper"
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    {{SenderName}}({{EmailFrom}}) shared a file with you</p>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: 700; margin: 0; margin-bottom: 16px;">
                                    {{Filename}}</p>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    {{Filesize}} KB</p>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; border-radius: 4px; text-align: center; background-color: #0070e0;"
                                                                valign="top" align="center" bgcolor="#0070e0"> <a
                                                                    href={{Url}} target="_blank"
                                                                    style="border: solid 2px #0070e0; border-radius: 4px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 16px; font-weight: bold; margin: 0; padding: 12px 24px; text-decoration: none; text-transform: capitalize; background-color: #0070e0; border-color: #0070e0; color: #ffffff;">Go
                                                                    TO Download Page</a> </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    You can Download Your file very Simple and Share with others.</p>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    Enjoy!<br>
                                    The Dropbox team.</p>
